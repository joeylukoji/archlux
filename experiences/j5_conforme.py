"""Couverture conforme de l'analytique contre SplitFluxOracle — jamais le réseau."""
...
sim, modele, rng = SplitFluxOracle(), SubstitutAnalytique(), np.random.default_rng(17)
pred_c, ver_c, sig_c = [], [], []
for _ in range(120):
