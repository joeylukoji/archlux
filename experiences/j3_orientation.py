...
plan = ax.Plan(
    (
        ax.Piece("sw", "sejour", 0, 0, 6, 4.5),
        ax.Piece("se", "chambre", 6, 0, 6, 4.5),
        ax.Piece("nw", "sejour", 0, 4.5, 6, 4.5),
        ax.Piece("ne", "chambre", 6, 4.5, 6, 4.5),
    ),
    (),
    (),
    C,
...
with out.open("w", newline="", encoding="utf-8") as handle:
    w = csv.DictWriter(handle, fieldnames=("deg", "divergent_de_l1", "gain", "h_sw", "h_nw"))
    w.writeheader()
