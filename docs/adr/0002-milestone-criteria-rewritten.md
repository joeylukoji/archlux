...
| J5 | Coverage measured over at least 20 calibration seeds (mean within 0.90 ± 0.02), two-sided. **Criterion added: mean width below one standard deviation of the target** (not met: 4 to 5). Coverage under selection reported, not guaranteed. | One run inside ±0.04 is one draw (4 of 20 runs fall out while the method is exact). The interval is 4 to 5 times the target spread, and under selection coverage drops to 0.878 on average, 0.787 at worst ([j5](../revues/j5.md)). |
