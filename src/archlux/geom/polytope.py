...
def construire_polytope(ordre: OrdreRelatif, ctx: Contexte) -> Polytope:
    ...
    return Polytope(
        ...
        # Vide, mais de forme correcte : voir ADR-7. Lier une pièce à un mur porteur
        # exige une incidence que cette signature ne permet pas de calculer. La structure
        # est vérifiée en aval par `certify.preuve`, jamais silencieusement ignorée.
